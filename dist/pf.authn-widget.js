(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["PfAuthnWidget"] = factory();
	else
		root["PfAuthnWidget"] = factory();
})(window, function() {
...
var AuthnApiError = __webpack_require__(/*! ./errors/AuthnApiError */ "./src/errors/AuthnApiError.js");

var fetchUtil = __webpack_require__(/*! ./utils/fetchUtil */ "./src/utils/fetchUtil.js");
...
function () {
   ...
   */
  function AuthnWidget(baseUrl, flowId) {
    _classCallCheck(this, AuthnWidget);
  ...
  _createClass(AuthnWidget, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetchUtil.getFlow(this.baseUrl, this.flowId);
    ...
    key: "getBrowserFlowId",
    value: function getBrowserFlowId() {
...
/*!********************************!*\
  !*** ./src/utils/fetchUtil.js ***!
  \********************************/
/*! exports provided: getFlow, postFlow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFlow", function() { return getFlow; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postFlow", function() { return postFlow; });
var AuthnApiError = __webpack_require__(/*! ../errors/AuthnApiError */ "./src/errors/AuthnApiError.js");

var ResultData = __webpack_require__(/*! ../ResultData */ "./src/ResultData.js");
...
function doRequest(baseUrl, method, flowId, contentType, body) {
  ...
  return fetch(url, options); // var jsonPromise = fetch(url, options);
...
function getFlow(baseUrl, flowId) {
  return doRequest(baseUrl, 'GET', flowId);
}
function postFlow(baseUrl, flowId, actionId, body) {
...
/***/ 0:
/*!******************************************************!*\
  !*** multi @babel/polyfill whatwg-fetch ./src/index ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! /Users/knadjafloo/git/pf-authn-widget/src/index */"./src/index.js");
...
//# sourceMappingURL=pf.authn-widget.map