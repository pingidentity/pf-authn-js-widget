...
At minimum you must include:
  ...
  - `https://assets.pingone.com/ux/end-user/0.32.0/end-user.css` - basic CSS from CDN
...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://assets.pingone.com/ux/end-user/0.32.0/end-user.css">
